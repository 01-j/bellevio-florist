  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-6 py-16">
        <h1 className="text-3xl font-light text-gray-900">Order Confirmation</h1>
        <p className="mt-2 text-gray-500">
          Your order receipt and delivery details will appear here. This feature is coming soon.
        </p>
        <div className="mt-12">
          <Link
            href="/"
